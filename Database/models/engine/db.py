...
class DataBase():
    ...
    def __init__(self):
        ...
        EHR_MYSQL_USER = getenv('EHR_MYSQL_USER')
        EHR_MYSQL_PWD = getenv('EHR_MYSQL_PWD')
        EHR_MYSQL_HOST = getenv('EHR_MYSQL_HOST')
        EHR_MYSQL_DB = getenv('EHR_MYSQL_DB')
        EHR_ENV = getenv('EHR_ENV')
